...
var TagCloud = React.createClass({
	...
	// we need to modify the props so that d3-cloud layout can work and modify these values. 
	// it is not a state.
	// unsure whether we should have a wrapper component to generate the modified props
//	tags: {}, 
    ...
    shouldComponentUpdate: function(nextProps) {
    	if (nextProps.tagsHaveUpdated === undefined) return true;
